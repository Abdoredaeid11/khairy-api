              ...
              <div class="navbar-nav-right d-flex align-items-center flex-grow-1" id="navbar-collapse">
                  ...
                  <div class="navbar-nav align-items-center">
                      <div class="nav-item d-flex align-items-center">
                          ...
                          <input type="text" class="form-control border-0 shadow-none" placeholder="{{ __('dashboard.overview') }}..."
                              aria-label="Search..." />
                      </div>
                  </div>
                  ...
                  <ul class="navbar-nav flex-row align-items-center ms-auto">
                      <li class="nav-item lh-1 me-3">
                          ...
                          @endphp
                          <a href="{{ route('lang', ['locale' => $currentLocale === 'en' ? 'ar' : 'en']) }}"
                              class="nav-link btn btn-sm btn-outline-primary py-1 px-2">
